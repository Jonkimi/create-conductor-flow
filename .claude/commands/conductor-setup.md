...
2.  **Select Code Style Guides:**
    -   List the available style guides by running `ls .claude/conductor/templates/code_styleguides/`.
    ...
    -   **Action:** Construct and execute a command to create the directory and copy all selected files. For example: `mkdir -p conductor/code_styleguides && cp .claude/conductor/templates/code_styleguides/python.md .claude/conductor/templates/code_styleguides/javascript.md conductor/code_styleguides/`
...
1.  **Copy Initial Workflow:**
    -   Copy `.claude/conductor/templates/workflow.md` to `conductor/workflow.md`.
