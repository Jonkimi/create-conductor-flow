...
const agents = [
	{
		...
		expectedDir: join(".agent", "workflows"),
		extension: ".md",
		usesPrefix: true,
	},
	{
		...
		expectedDir: join(".cursor", "commands"),
		extension: ".md",
		usesPrefix: true,
	},
	{
		...
		expectedDir: join(".windsurf", "workflows"),
		extension: ".md",
		usesPrefix: true,
	},
	{
		...
		expectedDir: join(".claude", "commands"),
		extension: ".md",
		usesPrefix: true,
	},
	{
		...
		expectedDir: join(".clinerules", "workflows"),
		extension: ".md",
		usesPrefix: true,
	},
	{
		...
		expectedDir: join(".codex", "prompts"),
		extension: ".md",
		usesPrefix: true,
	},
	{
		...
		expectedDir: join(".gemini", "commands", "conductor"),
		extension: ".toml",
	...
	},
	{
		...
		expectedDir: join(".opencode", "commands"),
		extension: ".md",
		usesPrefix: true,
	},
	{
	...
	},
	{
		...
		expectedDir: join(".kilocode", "workflows"),
		extension: ".md",
		usesPrefix: true,
	},
];
