...
describe('WindsurfGenerator', () => {
    let generator: WindsurfGenerator;
    ...
    describe('validate', () => {
        ...
        it('should throw if conductor is already installed', async () => {
            ...
            await expect(generator.validate(targetDir)).rejects.toThrow('Conductor (Windsurf) is already installed');
        });
    });
    ...
    describe('generate', () => {
        it('should create directories and files', async () => {
             ...
             expect(fs.ensureDir).toHaveBeenCalledWith(expect.stringContaining('.windsurf/workflows'));
