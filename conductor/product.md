...
- **Multi-Agent Support:** Built-in support for multiple AI agents including **OpenCode**, **Claude Code**, **Antigravity**, **Cursor**, and **VS Code Copilot**, with automated generation of tailored command structures and file formats for each.
