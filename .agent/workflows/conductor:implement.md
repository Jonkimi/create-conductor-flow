...
3.  **Handle User Response:**
    ...
    *   **If user chooses "B" (Archive):**
        ...
        iv.  **Commit Changes:** Stage the **Tracks Registry** file, moved track folder and `conductor/archive/`. Commit with the message `chore(conductor): Archive track '<track_description>'`.
